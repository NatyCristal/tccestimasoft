...
class ContagemEstimada extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    store.totalIndicativa =
        storeIndicativa.aies.length * 7 + storeIndicativa.alis.length * 7;
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Observer(builder: (context) {
                                return Text(
                                  "${store.totalPf + store.totalIndicativa} PF",
                    ...
                    SingleChildScrollView(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color: storeIndicativa.aies.isEmpty &&
                                    ...
                                    ? Column(
                                        ...
                                        children: [
                                          ...
                                          CardExibicaoContagem(
                                            ...
                                            storeIndicativa:
                                                storeIndicativa.alis,
                                          )
                                        ],
                                      )
                                    : const SizedBox(),
                            storeIndicativa.aies.isEmpty
                                ? Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                ...
                                : CardExibicaoContagem(
                                    ...
                                    storeIndicativa: storeIndicativa.aies,
                                  ),
                            const SizedBox(
                              height: 5,
                            )
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return CardAdicaoContagem(
                                  ...
                                  remover: () =>
                                      store.removerFuncao(nomeFuncao, "EE"),
                                  tipoFuncao: "EE",
