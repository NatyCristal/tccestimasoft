...
class ComplexidadeBaixaHandlerEe extends ArquivosHandler {
  @override
  bool calcular(IndiceDetalhada detalhada) {
    if (detalhada.quantidadeTDs <= 15 && detalhada.quantidadeTrsEArs <= 1) {
      detalhada.complexidade = Complexidades.baixa;
      detalhada.pontoDeFuncao = 3;
    }

    if ((detalhada.quantidadeTDs <= 15) && detalhada.quantidadeTrsEArs == 2) {
      detalhada.complexidade = Complexidades.baixa;
      detalhada.pontoDeFuncao = 3;
    }
